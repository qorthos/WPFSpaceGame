...
namespace WPFSpaceGame.Game
{
    ...
    public static class DoubleHelper
    {
        ...
        /// See <see cref="DoubleHelper.LerpPrecise"/> for a less efficient version with more precision around edge cases.
        /// </remarks>
        ...
        /// <summary>
        /// Linearly interpolates between two values.
        /// This method is a less efficient, more precise version of <see cref="DoubleHelper.Lerp"/>.
        ...
        /// Passing amount a value of 0 will cause value1 to be returned, a value of 1 will cause value2 to be returned.
        /// This method does not have the doubleing point precision issue that <see cref="DoubleHelper.Lerp"/> has.
        /// i.e. If there is a big gap between value1 and value2 in magnitude (e.g. value1=10000000000000000, value2=1),
        /// right at the edge of the interpolation range (amount=1), <see cref="DoubleHelper.Lerp"/> will return 0 (whereas it should return 1).
        /// This also holds for value1=10^17, value2=10; value1=10^18,value2=10^2... so on.
        /// For an in depth explanation of the issue, see below references:
        /// Relevant Wikipedia Article: https://en.wikipedia.org/wiki/Linear_interpolation#Programming_language_support
        /// Relevant StackOverflow Answer: http://stackoverflow.com/questions/4353525/doubleing-point-linear-interpolation#answer-23716956
        /// </remarks>
        ...
        public static double SmoothStep(double value1, double value2, double amount)
        {
            ...
            double result = DoubleHelper.Clamp(amount, 0f, 1f);
            result = DoubleHelper.Hermite(value1, 0f, value2, 0f, result);
