...
namespace MonoGame.Extended.Tweening
{
        ...
        where T : struct 
    {
        static TweenMember()
        {
            ...
            var c = Expression.Parameter(typeof(double));
            ...
            Multiply = Expression.Lambda<Func<T, double, T>>(Expression.Multiply(a, c), a, c).Compile();
        }

        public static Func<T, T, T> Add { get; }
        public static Func<T, T, T> Subtract { get; }
        public static Func<T, double, T> Multiply { get; }
