...
namespace MonoGame.Extended.Tweening
{
    ...
    public static class TweenHelper
    {
        ...
        /// See <see cref="TweenHelper.LerpPrecise"/> for a less efficient version with more precision around edge cases.
        /// </remarks>
        ...
        /// <summary>
        /// Linearly interpolates between two values.
        /// This method is a less efficient, more precise version of <see cref="TweenHelper.Lerp"/>.
        ...
        /// Passing amount a value of 0 will cause value1 to be returned, a value of 1 will cause value2 to be returned.
        /// This method does not have the doubleing point precision issue that <see cref="TweenHelper.Lerp"/> has.
        /// i.e. If there is a big gap between value1 and value2 in magnitude (e.g. value1=10000000000000000, value2=1),
        /// right at the edge of the interpolation range (amount=1), <see cref="TweenHelper.Lerp"/> will return 0 (whereas it should return 1).
        ...
        public static double SmoothStep(double value1, double value2, double amount)
        {
            ...
            double result = TweenHelper.Clamp(amount, 0f, 1f);
            result = TweenHelper.Hermite(value1, 0f, value2, 0f, result);
